  ...
  return (
    <div className="min-h-screen bg-[#0D0A08] text-[#FAF4EE] flex flex-col justify-between font-sans">
      ...
      <main className="flex-1 w-full max-w-[960px] mx-auto px-6 md:px-12 pt-36 pb-24 text-[#FAF4EE] leading-relaxed">
        ...
        {/* Sections Grid */}
        <div className="flex flex-col gap-16 text-sm md:text-[0.92rem] font-light text-[#D9C8B4]">
          
          {/* Daily Care & Storage Tips */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <section className="bg-[#16120F] border border-[#c89b3c]/20 rounded-sm p-6 md:p-8 flex flex-col gap-4 shadow-xl">
              <h2 className="font-sans text-base md:text-lg font-medium text-[#FAF4EE] tracking-wide m-0 uppercase flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37]" /> Daily Care
              </h2>
              <ul className="list-none p-0 m-0 flex flex-col gap-3 pl-2">
                <li className="relative pl-5 text-[#D9C8B4]">
                  <span className="absolute left-0 text-[#D4AF37] font-normal">&bull;</span>
            ...
            <section className="bg-[#16120F] border border-[#c89b3c]/20 rounded-sm p-6 md:p-8 flex flex-col gap-4 shadow-xl">
              <h2 className="font-sans text-base md:text-lg font-medium text-[#FAF4EE] tracking-wide m-0 uppercase flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37]" /> Storage Tips
              </h2>
              <ul className="list-none p-0 m-0 flex flex-col gap-3 pl-2">
                <li className="relative pl-5 text-[#D9C8B4]">
                  <span className="absolute left-0 text-[#D4AF37] font-normal">&bull;</span>
          ...
          <section className="flex flex-col gap-6">
            <h2 className="font-sans text-base md:text-lg font-medium text-[#FAF4EE] tracking-wide m-0 uppercase text-center mb-2">
              Care by Jewellery Type
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              
              {/* Jadau & Kundan */}
              <div className="bg-[#16120F] border border-[#c89b3c]/20 rounded-sm p-6 flex flex-col gap-3 shadow-xl">
                <h3 className="font-sans text-sm md:text-[0.95rem] font-semibold text-[#D4AF37] m-0 border-b border-[#c89b3c]/15 pb-2">
                  Jadau &amp; Kundan
                </h3>
                <ul className="list-none p-0 m-0 flex flex-col gap-2 pl-2">
                  <li className="relative pl-4 text-[#D9C8B4] text-[0.88rem]">
                    <span className="absolute left-0 text-[#D4AF37] font-normal">&bull;</span>
          ...
          <section className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Safe */}
              <div className="bg-[#16120F] border border-emerald-500/30 rounded-sm p-6 md:p-8 flex flex-col gap-4 shadow-xl">
                <h3 className="font-sans text-base font-semibold text-emerald-400 m-0 flex items-center gap-2">
                ...
                <ul className="list-none p-0 m-0 flex flex-col gap-3 pl-2">
                  <li className="relative pl-5 text-[#D9C8B4]">
                    <span className="absolute left-0 text-emerald-400 font-normal">&bull;</span>
              ...
              {/* Avoid */}
              <div className="bg-[#16120F] border border-red-500/30 rounded-sm p-6 md:p-8 flex flex-col gap-4 shadow-xl">
                <h3 className="font-sans text-base font-semibold text-red-400 m-0 flex items-center gap-2">
                  <svg viewBox="0 0 20 20" className="w-5 h-5 fill-current" xmlns="http://www.w3.org/2000/svg">
                ...
                <ul className="list-none p-0 m-0 flex flex-col gap-3 pl-2">
                  <li className="relative pl-5 text-[#D9C8B4]">
                    <span className="absolute left-0 text-red-400 font-normal">&bull;</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <section className="bg-[#16120F] border border-[#c89b3c]/20 rounded-sm p-6 md:p-8 flex flex-col gap-4 shadow-xl">
              <h2 className="font-sans text-base md:text-lg font-medium text-[#FAF4EE] tracking-wide m-0 uppercase flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37]" /> Best Practices
              </h2>
              <ul className="list-none p-0 m-0 flex flex-col gap-3 pl-2">
                <li className="relative pl-5 text-[#D9C8B4]">
                  <span className="absolute left-0 text-[#D4AF37] font-normal">&bull;</span>
            ...
            <section className="bg-[#16120F] border border-[#c89b3c]/20 rounded-sm p-6 md:p-8 flex flex-col gap-4 shadow-xl">
              <h2 className="font-sans text-base md:text-lg font-medium text-[#FAF4EE] tracking-wide m-0 uppercase flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#D4AF37]" /> Professional Care
              </h2>
              <ul className="list-none p-0 m-0 flex flex-col gap-3 pl-2">
                <li className="relative pl-5 text-[#D9C8B4]">
                  <span className="absolute left-0 text-[#D4AF37] font-normal">&bull;</span>
        ...
        {/* Final Note Quote */}
        <div className="mt-20 border-t border-[#c89b3c]/20 pt-10 text-center">
          <p className="font-cormorant italic font-light text-xl md:text-2xl text-[#D4AF37] max-w-[650px] mx-auto leading-relaxed">
